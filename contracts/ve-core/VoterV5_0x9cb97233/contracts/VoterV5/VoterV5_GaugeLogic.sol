...
contract VoterV5_GaugeLogic is IVoterV5_GaugeLogic, VoterV5_Storage, ERC165 {
    ...
    function createGauge(
        ...
        /// @dev INFRA_ADMIN can create for any pool, bypassing whitelist/eligibility checks
        bool isInfraAdmin = IPermissionsRegistry(permissionRegistry).hasRole("INFRA_ADMIN", msg.sender);
